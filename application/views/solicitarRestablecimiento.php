        ...
        <div class="container-login100">
            <div class="wrap-login10">
                <?php if ($this->session->flashdata('success')) : ?>
                    <div id="exito" class="alert alert-success mt-3" role="alert">
                ...
                <form class="login100-form validate-form" action="<?php echo site_url('usuario/enviarEnlaceRestablecimiento'); ?>" method="post">
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <button class="login100-form-btn" type="button" onclick="window.location.href='<?php echo site_url('usuario/login'); ?>'">
                            Volver
                        </button>
                    </div>
                </form>
